...
========================================================================
ROUND    1/4
STEP     AI reads baseline + previous response summaries
========================================================================
AI-IN    target=GET /api/spa/news.php query:id baseline_status=200 baseline_size=49B previous_rounds=0
AI-CALL  provider=openai_compatible/gh/gpt-5-mini
AI-RAW   received 220 chars, parsing JSON decision
AI-OUT   source=ai stop=false attack_type=sqli_error
AI-PAY   Payload generated by AI
PAYLOAD  1'
WHY      kiểm tra lỗi SQL khi đóng quote
EXPECT   SQL error in response
TOOL     Checking payload with PayloadGuard before sending
GUARD    payload hợp lệ
TOOL     Injecting payload into query:id
...
DETECT   Analyzing response for SQL errors, marker paths, and confirmed signal
